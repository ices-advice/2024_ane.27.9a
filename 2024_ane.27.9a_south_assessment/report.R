...
#> setwd("~/Documents/ICES grupos/TAF/TAF2024_definitive_data_3")
#> setwd("~/Documents/ICES grupos/TAF/2024_ane.27.9a_south_assessment")
...
cp("Assessment2024prov_May8.Rnw","report")
#cp("bootstrap/initial/software/Latex/*","report")
taf.library(Rgadget)
setwd("report")

Sweave("Assessment2024prov_May8.Rnw" , encoding = "UTF-8")
ret<-"Assessment2024prov_May8.tex"
x <- system(paste('pdflatex -halt-on-error', ret))
reti<-"Assessment2024prov_May8.aux"
